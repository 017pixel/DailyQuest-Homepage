...
// --- Installation Tutorial Modal Logic ---
document.addEventListener('DOMContentLoaded', () => {
    const tutorialModal = document.getElementById('install-tutorial-modal');
    const showButton = document.getElementById('show-tutorial-btn');
    ...
    const backButtons = document.querySelectorAll('.back-to-os-selection');
    ...
    const hideModal = () => {
        if (tutorialModal) {
            ...
            // Reset to the initial OS selection screen
            osSelectionScreen.style.display = 'block';
